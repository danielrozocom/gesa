...
title GESA - Gestor de Evaluaciones de Suficiencia AcadÃ©mica
...
echo ========================================
echo v1.0 ^| Generacion automática de exámenes
echo.
...
echo.
echo [4/5] Verificando Microsoft Word...
...
echo.
echo [5/5] Arrancando aplicación...
echo.
echo ========================================
echo        TODO LISTO
echo ========================================
